<?php require_once('header.php'); ?>
            <section id="sell">
              <header class="article-header">
                <h1>Sell it in <span class="glyphicon glyphicon-map-marker"></span> <a href="#">Afton, MN</a></h1>
              </header>
              ...
              <div class="row text-center sub-section one-true" style="margin-top: 30px">
                ...
                <article class="col-xs-5 pilar" style="background: #f7f4ed; margin-left: auto; margin-right: auto; float: none; padding-top: 0;">
                  ...
                  <div class="h1" style="margin-bottom: 5px"><s>$9.99</s></div>
                  <div style="margin-bottom: 20px; color: #999;">Save $10 for a limited time</div>
                  <form action="create-ad.php">
                    <button type="submit" class="btn btn-lg btn-callOA-contrast">Get Started <span class="glyphicon glyphicon-chevron-right"></span></button>
                  </form>
                </article>
              </div>
